...
[![npm version](https://badge.fury.io/js/@token_prime%2Fsdk.svg)](https://badge.fury.io/js/@token_prime%2Fsdk)
...
```bash
npm install @token_prime/sdk viem
# or
yarn add @token_prime/sdk viem
# or
pnpm add @token_prime/sdk viem
```

### Basic Usage

```typescript
import { createENR1MClient, SUPPORTED_CHAINS } from '@token_prime/sdk'
...
```typescript
import { ENR1MClient, createENR1MClient } from '@token_prime/sdk'
...
// Calculations
import { calculateUserShare, calculateAPY } from '@token_prime/sdk'
...
// Time helpers
import { getRecordDate, getDistributionDate, getClaimDeadline } from '@token_prime/sdk'
...
```typescript
import { CHAIN_CONFIGS, getChainConfig } from '@token_prime/sdk'
...
- **NPM**: [@token_prime/sdk](https://www.npmjs.com/package/@token_prime/sdk)
